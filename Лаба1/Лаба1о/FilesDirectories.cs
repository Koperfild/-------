...
namespace Лаба1
{
    ...
    public static class FilesDirectories
    {
        ...
        public static string AirMapTestDirectory { get; set; }//Наверное в топку
        public static string GraphMapTestDirectory { get; set; }
        ...
        public static string AirMapTest { get; set; }//В топку
        public static string GraphMapTest { get; set; }//В топку
        public static string Test_BuildAirRace { get; set; }//В топку
        static FilesDirectories()//Или можно откуда-то считывать все нужные файлы
        {
            ...
            GraphMapTestDirectory=@"GraphMapTest\bin\Debug";
        }
